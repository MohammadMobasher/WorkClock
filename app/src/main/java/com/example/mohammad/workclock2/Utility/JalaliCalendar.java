...
public class JalaliCalendar extends Calendar {
    ...
    public static gDate jalaliToMiladi(String mydate) {
        gDate jalali = new gDate(mydate);
        if (jalali.getMonth() > 11 || jalali.getMonth() < -11) {
            throw new IllegalArgumentException();
        }
    ...
    public static class gDate
    {
        ...
        public gDate(String Date_){
            String[] split_ = Date_.split("/");
            this.year = Integer.parseInt(split_[0]);
            this.month = Integer.parseInt(split_[1]);
            this.day = Integer.parseInt(split_[2]);
        }
